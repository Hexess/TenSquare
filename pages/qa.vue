    ...
    <div>
         <div class="tab-nav "> 
            <div class="wrapper"> 
                ...
                <router-link tag="li" active-class="active" to="/qa/label/0" exact ><a>Homepage</a></router-link>
                ...
                <span class="fr more"><a href="~/assets/qa-allTag.html" target="_blank">More</a></span> 
